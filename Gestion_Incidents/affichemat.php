...
<div id="page">
	<section id="afficher">
    <form method="post" action="#affichetype">
        
           <label id="la">Selectionner :
            ...
            <input type="submit" name="b1" id="b1" value="Afficher">
        </form>
	  <table width="900" height="65" border="1" cellpadding="3">
<caption>
          <span class="style1">Tout Les Materiéls</span> <br>
          <br />
        </caption>
        <br />
        <br />
    ...
    $ins=$bdd->query('SELECT * FROM materiel WHERE Resultat_tr=\''.$_POST['form1'].'\'');
